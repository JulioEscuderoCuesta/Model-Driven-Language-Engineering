...
/**
 * This is the item provider adapter for a {@link flight_planner.Base} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BaseItemProvider extends PlaceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Base_infrastructure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Base_infrastructure_feature", "_UI_Base_type"),
				 Flight_plannerPackage.Literals.BASE__INFRASTRUCTURE,
				 true,
				 false,
				 true,
				 null,
