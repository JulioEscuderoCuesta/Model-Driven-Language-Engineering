...
/**
 * This is the item provider adapter for a {@link factory.ConveyorBelt} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConveyorBeltItemProvider extends ElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FactoryPackage.Literals.CONVEYOR_BELT__CAPACITY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FactoryPackage.Literals.CONVEYOR_BELT__COMPONENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConveyorBelt.class)) {
			case FactoryPackage.CONVEYOR_BELT__CAPACITY:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case FactoryPackage.CONVEYOR_BELT__COMPONENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FactoryPackage.Literals.CONVEYOR_BELT__COMPONENTS,
				 FactoryFactory.eINSTANCE.createCandyFlat()));

		newChildDescriptors.add
			(createChildParameter
				(FactoryPackage.Literals.CONVEYOR_BELT__COMPONENTS,
				 FactoryFactory.eINSTANCE.createStick()));

		newChildDescriptors.add
			(createChildParameter
				(FactoryPackage.Literals.CONVEYOR_BELT__COMPONENTS,
				 FactoryFactory.eINSTANCE.createCandyBall()));

		newChildDescriptors.add
			(createChildParameter
				(FactoryPackage.Literals.CONVEYOR_BELT__COMPONENTS,
				 FactoryFactory.eINSTANCE.createLollipop()));
	}
