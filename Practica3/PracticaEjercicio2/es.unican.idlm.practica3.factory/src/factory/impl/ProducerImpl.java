 ...
 * </p>
 * <ul>
 *   <li>{@link factory.impl.ProducerImpl#getCounter <em>Counter</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ProducerImpl extends MachineImpl implements Producer {
	...
	protected EClass eStaticClass() {
		return FactoryPackage.Literals.PRODUCER;
	}
	...
	public void setCounter(int newCounter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FactoryPackage.PRODUCER__COUNTER, oldCounter, counter));
	}
