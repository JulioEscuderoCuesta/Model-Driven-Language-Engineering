 ...
 * @generated
 */
public class Candy_factorySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Candy_factoryPackage.FACTORY: {
				Factory factory = (Factory)theEObject;
				T result = caseFactory(factory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Candy_factoryPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Candy_factoryPackage.MACHINE: {
			...
			case Candy_factoryPackage.CONVEYOR_BELT: {
			...
			case Candy_factoryPackage.PRODUCER: {
			...
			case Candy_factoryPackage.ASSEMBLER: {
			...
			case Candy_factoryPackage.WRAPPER: {
			...
			case Candy_factoryPackage.FLATTENER: {
			...
			case Candy_factoryPackage.COMPONENT: {
				Component component = (Component)theEObject;
				T result = caseComponent(component);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Candy_factoryPackage.CANDY_PRODUCER: {
			...
			case Candy_factoryPackage.STICK_PRODUCER: {
			...
			case Candy_factoryPackage.STICK: {
			...
			case Candy_factoryPackage.CANDY_FLAT: {
			...
			case Candy_factoryPackage.CANDY_BALL: {
			...
			case Candy_factoryPackage.LOLLIPOP: {
