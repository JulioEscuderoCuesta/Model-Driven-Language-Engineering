 ...
 * </p>
 * <ul>
 *   <li>{@link candy_factory_v2.impl.MachineImpl#getProcessingTime <em>Processing Time</em>}</li>
 *   <li>{@link candy_factory_v2.impl.MachineImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link candy_factory_v2.impl.MachineImpl#getInput <em>Input</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MachineImpl extends ElementImpl implements Machine {
	...
	protected EClass eStaticClass() {
		return Candy_factory_v2Package.Literals.MACHINE;
	}
	...
	public void setProcessingTime(int newProcessingTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Candy_factory_v2Package.MACHINE__PROCESSING_TIME, oldProcessingTime, processingTime));
	}
	...
	public ConveyorBelt getOutput() {
		if (output != null && output.eIsProxy()) {
			...
			if (output != oldOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Candy_factory_v2Package.MACHINE__OUTPUT, oldOutput, output));
			}
		}
		return output;
	}
	...
	public NotificationChain basicSetOutput(ConveyorBelt newOutput, NotificationChain msgs) {
		...
		output = newOutput;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Candy_factory_v2Package.MACHINE__OUTPUT, oldOutput, newOutput);
	...
	public void setOutput(ConveyorBelt newOutput) {
		if (newOutput != output) {
			...
			if (output != null)
				msgs = ((InternalEObject)output).eInverseRemove(this, Candy_factory_v2Package.CONVEYOR_BELT__SOURCE, ConveyorBelt.class, msgs);
			if (newOutput != null)
				msgs = ((InternalEObject)newOutput).eInverseAdd(this, Candy_factory_v2Package.CONVEYOR_BELT__SOURCE, ConveyorBelt.class, msgs);
			msgs = basicSetOutput(newOutput, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Candy_factory_v2Package.MACHINE__OUTPUT, newOutput, newOutput));
	}
	...
	public EList<ConveyorBelt> getInput() {
		if (input == null) {
			input = new EObjectWithInverseResolvingEList<ConveyorBelt>(ConveyorBelt.class, this, Candy_factory_v2Package.MACHINE__INPUT, Candy_factory_v2Package.CONVEYOR_BELT__TARGET);
		}
		return input;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Candy_factory_v2Package.MACHINE__OUTPUT:
				if (output != null)
					msgs = ((InternalEObject)output).eInverseRemove(this, Candy_factory_v2Package.CONVEYOR_BELT__SOURCE, ConveyorBelt.class, msgs);
				return basicSetOutput((ConveyorBelt)otherEnd, msgs);
			case Candy_factory_v2Package.MACHINE__INPUT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Candy_factory_v2Package.MACHINE__PROCESSING_TIME:
