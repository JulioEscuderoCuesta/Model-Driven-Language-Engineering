 ...
 * </p>
 * <ul>
 *   <li>{@link candy_factory_v2.impl.ProducerImpl#getCounter <em>Counter</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ProducerImpl extends MachineImpl implements Producer {
	...
	protected EClass eStaticClass() {
		return Candy_factory_v2Package.Literals.PRODUCER;
	}
	...
	public void setCounter(int newCounter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Candy_factory_v2Package.PRODUCER__COUNTER, oldCounter, counter));
	}
