...
public class InventoryPackageImpl extends EPackageImpl implements InventoryPackage {
	 ...
	 * @see es.unican.ildm.inventory.inventory.InventoryPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getInventory_Items() {
	...
	public void createPackageContents() {
		...
		createEReference(inventoryEClass, INVENTORY__ITEMS);
		...
		createEReference(itemEClass, ITEM__TAG);
	...
	public void initializePackageContents() {
		...
		initEReference(getInventory_Items(), this.getItem(), null, "items", null, 0, -1, Inventory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAsset_AssetType(), ecorePackage.getEString(), "assetType", null, 0, 1, Asset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAsset_Location(), this.getLocation(), "location", null, 0, 1, Asset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getItem_State(), this.getState(), "state", null, 0, 1, Item.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getItem_Price(), ecorePackage.getEDoubleObject(), "price", null, 0, 1, Item.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getItem_Tag(), this.getTag(), null, "tag", null, 0, -1, Item.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(locationEEnum, Location.GROUND_FLOOR);
		addEEnumLiteral(locationEEnum, Location.FIRST_FLOOR);
		addEEnumLiteral(locationEEnum, Location.SECOND_FLOOR);

		initEEnum(stateEEnum, State.class, "State");
		addEEnumLiteral(stateEEnum, State.FINISHED);
		addEEnumLiteral(stateEEnum, State.UNFINISHED);
