 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.ildm.inventory.inventory.impl.InventoryImpl#getAssets <em>Assets</em>}</li>
 *   <li>{@link es.unican.ildm.inventory.inventory.impl.InventoryImpl#getItems <em>Items</em>}</li>
 *   <li>{@link es.unican.ildm.inventory.inventory.impl.InventoryImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InventoryImpl extends MinimalEObjectImpl.Container implements Inventory {
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<Item>(Item.class, this, InventoryPackage.INVENTORY__ITEMS);
		}
		return items;
	}
