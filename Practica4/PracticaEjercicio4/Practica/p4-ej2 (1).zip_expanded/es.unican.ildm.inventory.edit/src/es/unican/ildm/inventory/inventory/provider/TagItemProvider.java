...
/**
 * This is the item provider adapter for a {@link es.unican.ildm.inventory.inventory.Tag} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TagItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tag_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tag_label_feature", "_UI_Tag_type"),
				 InventoryPackage.Literals.TAG__LABEL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Tag)object).getLabel();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Tag.class)) {
			case InventoryPackage.TAG__LABEL:
