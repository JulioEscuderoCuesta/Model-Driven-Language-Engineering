...
/**
 * This is the item provider adapter for a {@link es.unican.ildm.inventory.inventory.Asset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Asset_assetType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Asset_assetType_feature", "_UI_Asset_type"),
				 InventoryPackage.Literals.ASSET__ASSET_TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Asset_location_feature", "_UI_Asset_type"),
				 InventoryPackage.Literals.ASSET__LOCATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Asset)object).getAssetType();
