...
/**
 * This is the item provider adapter for a {@link candy_factory.ConveyorBelt} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConveyorBeltItemProvider extends ElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Candy_factoryPackage.Literals.CONVEYOR_BELT__CAPACITY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Candy_factoryPackage.Literals.CONVEYOR_BELT__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Candy_factoryPackage.Literals.CONVEYOR_BELT__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Candy_factoryPackage.Literals.CONVEYOR_BELT__COMPONENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Candy_factoryPackage.Literals.CONVEYOR_BELT__COMPONENT,
				 Candy_factoryFactory.eINSTANCE.createStick()));

		newChildDescriptors.add
			(createChildParameter
				(Candy_factoryPackage.Literals.CONVEYOR_BELT__COMPONENT,
				 Candy_factoryFactory.eINSTANCE.createCandyFlat()));

		newChildDescriptors.add
			(createChildParameter
				(Candy_factoryPackage.Literals.CONVEYOR_BELT__COMPONENT,
				 Candy_factoryFactory.eINSTANCE.createCandyBall()));

		newChildDescriptors.add
			(createChildParameter
				(Candy_factoryPackage.Literals.CONVEYOR_BELT__COMPONENT,
				 Candy_factoryFactory.eINSTANCE.createLollipop()));
	}
